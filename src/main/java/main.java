    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (wyborroli == 1 ) {
                ...
                if(wyborsprzetu ==1){
                    ...
                    do {
                        ...
                        System.out.println("Dodać kolejną osobę wypozyczającą? ");
                ...
                if (wyborsprzetu == 2) { //snowboard
                    ...
                    do {
                        ...
                        System.out.println("Twoje wypożyczenie: ");
                        System.out.println("RentID" + rentid + " Czas trwania: "+ rent2.getRentDays() + " Klient: " + tabCLIENT[i].toString() + " Sprzęt: " + managmentOfEquipment.tabEQUIPMENT[wybor-1].toString() + managmentOfEquipment.tabSNOWBOARD[wybor-1].toString());
                        System.out.println("Koszt wypożyczenia: ");
            ...
            if (wyborroli == 2) {
                ...
                System.out.println("3. Bazę wypozyczeń");
                int wyborzadania = scan.nextInt();
                if (wyborzadania == 1) {
                    System.out.println(managmentOfEquipment.policz().toString());
                }
                if(wyborzadania == 2){
                    System.out.println(managmentOfClients.policz().toString());
                }
                if(wyborzadania == 3) {
                    System.out.println(managmentOfRents.policz().toString());
                }
            }
